...
<body>
    ...
    <form class="form-control w-50" method="POST" action="user_data.php">
        ...
        <div class="form-row flex justify-content-center">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="date" placeholder="" name="password" required>
            </div>
        ...
        <p>Gender:<br>
            <input class="input" type="radio" name="gender" value="male">Male<br>
            <input class="input" type="radio" name="gender" value="female">Female<br>
            <input class="input" type="radio" name="gender" value="other">Other<br>
